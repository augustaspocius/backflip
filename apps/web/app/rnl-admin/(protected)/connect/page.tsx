...
export const metadata: Metadata = { title: titleFor("/rnl-admin/connect") }
...
/**
 * `/rnl-admin/connect` — OAuth 2.1 consent screen (`L2-MCP-13`, `L2-MCP-14`).
 * Lives inside `(protected)`; the edge gate already routes an unauthenticated
 * visitor through `/rnl-admin/login?from=…` and back (`L2-AUTH-01`), so only the
