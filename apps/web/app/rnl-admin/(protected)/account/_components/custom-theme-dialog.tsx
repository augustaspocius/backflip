 ...
 * Repeat and Learn ships for the custom theme, the pairs you saved, and the two colour
 * inputs behind them.
 *
...
export function CustomThemeDialog({
  ...
  // The server revalidates `/rnl-admin/account` after every write, so props are
