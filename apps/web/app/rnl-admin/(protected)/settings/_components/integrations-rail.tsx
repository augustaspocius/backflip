...
> = {
  ai: {
    ...
    body: "Repeat and Learn talks to model providers through the Vercel AI SDK. Set one provider as default; enable the ones you want available.",
    ...
    links: [
      {
        ...
        href: "https://github.com/augustaspocius/backflip/blob/master/docs/notes/mcp.md",
      },
    ],
  },
}
