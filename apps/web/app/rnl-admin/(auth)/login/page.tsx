...
/**
 * Scopes this login page authenticates into. `/rnl-admin/*` is the operator
 ...
 */
const LOGIN_SCOPES = ["/rnl-admin", "/learn"] as const
...
/**
 * /rnl-admin/login — public login (credentials + Google) shared by the
 * `/rnl-admin` console and the `/learn` product.
