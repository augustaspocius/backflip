...
## Owns
n8n operator config under `/rnl-admin/settings` (backed by `n8n_config`) — one instance URL + public API key + enabled flag — plus a read-only connection probe.
